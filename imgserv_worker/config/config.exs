...
#
#     config :imgserv_worker, key: :value
#
# and access this configuration in your application as:
#
#     Application.get_env(:imgserv_worker, :key)
#
...
config :libcluster,
  topologies: [
    local: [
      ...
      config: [hosts: [:"worker1@127.0.0.1", :"worker2@127.0.0.1", :"worker3@127.0.0.1", :"db@127.0.0.1"]],
    ]
  ]
